...
<b> svrouter </b> is a cross-platform, command-dictionary manager tool for creating custom console commands with shortcuts. Available for Linux, Windows and MacOS architectures.
